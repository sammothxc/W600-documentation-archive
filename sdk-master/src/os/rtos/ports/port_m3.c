...
#define configMAX_SYSCALL_INTERRUPT_PRIORITY 	31 /* equivalent to 0xb0, or priority 11. */
#endif
...
__asm void portDISABLE_INTERRUPTS( void )
{
	PRESERVE8
...
__asm void portENABLE_INTERRUPTS( void )
{
	PRESERVE8
...
__asm int ulSetInterruptMaskFromISR( void )
{
	PRESERVE8
/*
	push { r0 }
...
__asm void vClearInterruptMaskFromISR( int ulMask )
{
	PRESERVE8
